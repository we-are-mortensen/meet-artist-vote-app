  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-paper bg-confetti">
      <div className="max-w-2xl text-center">
        ...
        <h1 className="font-heading text-5xl md:text-6xl font-bold text-crayon-purple mb-4">Qui és l&apos;artista?</h1>

        <p className="font-body text-xl text-text-primary mb-8">Comparteix aquesta pàgina per activar el complement de Google Meet i començar la votació.</p>

        <div className="bg-card border-4 border-crayon-blue hand-drawn p-6 mb-8 shadow-playful">
          <p className="font-heading text-xl text-crayon-blue font-bold mb-4">📺 Per començar:</p>
        ...
        <p className="font-heading text-2xl text-crayon-yellow font-bold">Qui serà l&apos;artista d&apos;avui? 🌟</p>
      </div>
    </div>
  );
}
